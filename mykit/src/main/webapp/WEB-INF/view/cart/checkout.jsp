...
<style type="text/css">
	* {margin: auto;}
	...
	#th1, .th2 {border-right:1px solid #e8e8e8;}
	.th2, #th3 {border-left:1px solid #e8e8e8;}
...
<h3 id="cart-sub-title">배송지 정보</h3>
<table id="t1">
	<tr class="cart-info">
		<th width="30%">아이디</th>
...
<table id="t2">
	<tr class="cart-info">
  	...
  	<tr>
  		...
  		<p id="effect-m">할인 받으실 금액 : ${usepoint}원</p></td></tr>
</table>
<div id="dv2">
<form action="end">
