...
<form:form modelAttribute="user" action="idsearch" method="post" name="idform">
	...
	<table>
		...
		<tr><td colspan="2" class="sb"><input type="submit" value="아이디 찾기"></td><td></td></tr>
		<tr><td class="user-info" colspan="3">이메일 전송을 원하시면 <a class="user-special" href ="idsend">여기</a>를 눌러주세요</td></tr>
	</table>
</form:form>
</body>
</html>