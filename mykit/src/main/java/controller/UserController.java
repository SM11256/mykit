...
public class UserController {
	...
	public void emailsend(String em, String id, String pw, String word) throws Exception{
		...
		String hostSMTPid = "iamhayom@naver.com"; //보내는 사람 이메일 주소
		String hostSMTPpwd = "k140mgh125y!"; //보내는 사람 이메일 비번
		// 보내는 사람 E-Mail, 제목, 내용
		String fromEmail = "iamhayom@naver.com"; //보내는 사람 이메일주소(받는 사람 이메일에 표시됨)
		...
		if(word.equals("비밀번호")) {
			...
			msg += "<div align='center' style='border:1px solid #FD9F28; font-family:verdana'>";
			msg += "<h3 style='color: #FD9F28;'>";
