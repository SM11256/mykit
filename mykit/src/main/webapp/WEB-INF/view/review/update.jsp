...
<table id="mypage-t1" style="height:600px;">
	<tr><th id="mypage-th"><h3 id="user-name">리뷰 수정</h3></th></tr>
	<tr><td>
	...
	<table>
		...
		<tr>
			<th id="review-up">아이디</th><td><form:input path="userid" readonly="true"/></td>
			<th id="review-up">상품번호</th><td><form:input path="itemid" readonly="true"/></td>
		</tr>
		<tr>
	...
	<div id="review-detail-m">
		<a href="javascript:document.updateform.submit()"><i class="far fa-check-circle fa-border"></i></a>
